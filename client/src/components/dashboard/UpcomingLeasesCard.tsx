    ...
    return (
        <Card borderColor="info">
            <div className="flex items-start justify-between mb-4">
                <h2 className="text-xl font-semibold text-gray-800">Lease Renewals</h2>
            </div>

            <div className="text-3xl font-bold text-blue-500">{renewalCount}</div>
            <div className="mt-1 text-gray-500 text-sm">Within the next 12 months</div>
            ...
            <div className="mt-6 space-y-3">
                {upcomingRenewals.length > 0 ? (
                    upcomingRenewals.slice(0, 2).map((lease: ExtendedLease) => {
                        ...
                        return (
                            <div key={lease.id} className="p-4 rounded-lg border border-gray-200 bg-gradient-to-r from-white to-gray-50/30 hover:shadow-sm transition-shadow">
                                <div className="flex justify-between">
                                    <div className="font-medium text-gray-800">{lease.propertyAddress}</div>
                                ...
                                <div className="mt-3 w-full bg-gray-200/30 rounded-full h-2">
                                    <div
